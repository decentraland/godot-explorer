...
pub const GODOT4_BIN_BASE_URL: &str =
    "https://godot-engine-releases.dclexplorer.com//branches/feat-add-firebase-and-install-referrer/editors/";

pub const GODOT_CURRENT_VERSION: &str = "4.5.1";

pub const GODOT4_EXPORT_TEMPLATES_BASE_URL: &str =
    "https://godot-engine-releases.dclexplorer.com//branches/feat-add-firebase-and-install-referrer/compressed-templates/";

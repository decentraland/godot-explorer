...
pub const GODOT4_BIN_BASE_URL: &str =
    "https://godot-engine-releases.dclexplorer.com/4.6.1.stable/editors/";

pub const GODOT_CURRENT_VERSION: &str = "4.6.1";

pub const GODOT4_EXPORT_TEMPLATES_BASE_URL: &str =
    "https://godot-engine-releases.dclexplorer.com/4.6.1.stable/compressed-templates/";

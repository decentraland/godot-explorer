...
static func build_cube_arrays() -> Array:
	...
	# Face 0 (top) - Unity: (1,1),(1,0),(0,0),(0,1) → Godot 1-U,V: (0,1),(0,0),(1,0),(1,1)
	uvs.append(Vector2(0, 1))
	uvs.append(Vector2(0, 0))
	uvs.append(Vector2(1, 0))
	uvs.append(Vector2(1, 1))

	# Face 1 (bottom) - Unity: (1,0),(1,1),(0,1),(0,0) → Godot 1-U,V: (0,0),(0,1),(1,1),(1,0)
	uvs.append(Vector2(0, 0))
	uvs.append(Vector2(0, 1))
	uvs.append(Vector2(1, 1))
	uvs.append(Vector2(1, 0))

	# Face 2 (left) - Unity: (1,1),(1,0),(0,0),(0,1) → Godot 1-U,V: (0,1),(0,0),(1,0),(1,1)
	uvs.append(Vector2(0, 1))
	uvs.append(Vector2(0, 0))
	uvs.append(Vector2(1, 0))
	uvs.append(Vector2(1, 1))

	# Face 3 (right) - Unity: (1,0),(1,1),(0,1),(0,0) → Godot 1-U,V: (0,0),(0,1),(1,1),(1,0)
	uvs.append(Vector2(0, 0))
	uvs.append(Vector2(0, 1))
	uvs.append(Vector2(1, 1))
	uvs.append(Vector2(1, 0))

	# Face 4 (front) - Unity: (0,0),(1,0),(1,1),(0,1) → Godot 1-U,V: (1,0),(0,0),(0,1),(1,1)
	uvs.append(Vector2(1, 0))
	uvs.append(Vector2(0, 0))
	uvs.append(Vector2(0, 1))
	uvs.append(Vector2(1, 1))

	# Face 5 (back) - Unity: (0,1),(1,1),(1,0),(0,0) → Godot 1-U,V: (1,1),(0,1),(0,0),(1,0)
	uvs.append(Vector2(1, 1))
	uvs.append(Vector2(0, 1))
	uvs.append(Vector2(0, 0))
	uvs.append(Vector2(1, 0))

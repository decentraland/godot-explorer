...
func _process(delta):
	...
	animation_tree.set("parameters/Locomotion/conditions/run", self.run)
	animation_tree.set("parameters/Locomotion/conditions/jog", self.jog)
	animation_tree.set("parameters/Locomotion/conditions/walk", self.walk)
	...
	animation_tree.set("parameters/Locomotion/conditions/start_glide", glide_opening)

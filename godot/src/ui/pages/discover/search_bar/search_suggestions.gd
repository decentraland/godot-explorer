...
func _build_suggestions_ui(
	...
	const SEARCH = preload("res://src/ui/pages/discover/icons/search-outlined.svg")
	const CLOCK = preload("res://src/ui/pages/discover/icons/clock.svg")
	const MAP = preload("res://src/ui/pages/discover/icons/world-outlined.svg")
	const CALENDAR = preload("res://src/ui/pages/discover/icons/calendar-outlined.svg")
	const KEYWORD = preload("res://src/ui/pages/discover/search_keyword.tscn")

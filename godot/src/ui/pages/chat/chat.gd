...
const ChatMessage := preload("res://src/ui/pages/chat/chat_message.gd")
...
const HEADER_LABEL_LANDSCAPE := "COMMON_NEARBY"
...
func _setup_autocomplete() -> void:
	_mention_item_scene = load("res://src/ui/pages/chat/mention_item.tscn")

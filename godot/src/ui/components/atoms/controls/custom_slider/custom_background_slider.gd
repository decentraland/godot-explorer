...
var color_background_texture = preload(
	"res://src/ui/components/atoms/controls/custom_slider/color_slider_texture.tres"
)
var brightness_background_texture = preload(
	"res://src/ui/components/atoms/controls/custom_slider/brightness_slider_texture.tres"
)
var saturation_background_texture = preload(
	"res://src/ui/components/atoms/controls/custom_slider/saturation_slider_texture.tres"
)

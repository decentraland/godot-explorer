...
@onready var button_back = $PanelContainer/MarginContainer_Navigation/HBoxContainer/VBoxContainer_Left/Button_Back
@onready var button_close = $PanelContainer/MarginContainer_Navigation/HBoxContainer/VBoxContainer_Right/Button_Close

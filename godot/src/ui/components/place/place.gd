...
@onready var button_like = $MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/HBoxContainer2/Button_Like
@onready var button_dislike = $MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/HBoxContainer2/Button_Dislike
@onready var button_fav = $MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/HBoxContainer2/Button_Fav
@onready var button_share = $MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/HBoxContainer2/Button_Share
@onready var button_home = $MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/HBoxContainer2/Button_Home

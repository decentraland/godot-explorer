...
func focus_camera_on(type):
	...
	match type:
		Wearables.Categories.HAIR, \
		Wearables.Categories.FACIAL_HAIR, \
		Wearables.Categories.EYEWEAR, \
		Wearables.Categories.TIARA, \
		Wearables.Categories.FACIAL, \
		Wearables.Categories.EYEBROWS, \
		Wearables.Categories.MOUTH, \
		Wearables.Categories.HAT, \
		Wearables.Categories.EARRING, \
		Wearables.Categories.MASK, \
		Wearables.Categories.HELMET, \
		Wearables.Categories.TOP_HEAD, \
		Wearables.Categories.EYES:

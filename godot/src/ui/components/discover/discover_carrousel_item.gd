...
@onready var label_title = $MarginContainer/DiscoverCarrouselItem/Panel/MarginContainer/VBoxContainer/Label_Title
@onready var label_description = $MarginContainer/DiscoverCarrouselItem/Panel/MarginContainer/VBoxContainer/Label_Description
